                ...
                <form action="<?php echo $_SERVER["REQUEST_URI"] ?>" method="post" id="mailform" class="section04-form form-responsive">
                    ...
                    <div class="section04-row">
                        ...
                        <div class="section04-input section04-radio-group">
                            <label><input name="ご相談内容" type="radio" value="inspection" checked> 点検・メンテナンスのご相談</label>
                            <label><input name="ご相談内容" type="radio" value="installation"> 設置・工事のご相談</label>
                            <label><input name="ご相談内容" type="radio" value="other"> その他のお問い合わせ</label>
                        </div>
                    </div>
...
<?php if (@$test): ?>
    ...
    <a class="myImage" href="" target="_blank">
      <picture class="d-none d-lg-block">
        <source type="image/webp" srcset="<?php echo get_theme_file_uri(); ?>/lp_assets/img/floting_banner.webp">
        <img class="img-fluid banner-icon myImage" src="<?php echo get_theme_file_uri(); ?>/lp_assets/img/floting_banner.png" alt="公式HPで詳しく見る" loading="lazy" width="400" height="310">
      </picture>
    ...
    <div class="container py-4 text-center">
      <p class="text-white small mb-0">© <span class="site_name">[比較メディアサイト名]</span></p>
        ...
        <script async src="<?php echo get_theme_file_uri(); ?>/lp_assets/js/bootstrap.bundle.min.js"></script>
