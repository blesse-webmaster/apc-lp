...
<body class="thanks-page">
                ...
                <div class="container-fluid" style="--bs-gutter-x: 0;">
                    <div class="w-100">
                        ...
                        <div class="collapse navbar-collapse justify-content-between align-items-center pt-3 pb-2 mx-3 mx-xxl-5 px-2 " id="navbarNavDropdown">
                            <a class="nav-link fw-bold fs-6 py-2 text-black d-none d-lg-block text-shadow_white site_name" aria-current="page" href="<?php echo home_url('lp'); ?>">
                                <picture>
                            ...
                            <ul class="navbar-nav align-items-center">
                                <li class="nav-item text-center mb-3 mb-lg-0 d-block d-lg-none">
                                    <a class="nav-link fw-bold fs-6 py-2 text-black site_name" aria-current="page" href="<?php echo home_url('lp'); ?>">
                                        <picture>
                                            <source type="image/webp" srcset="<?php echo get_theme_file_uri(); ?>/lp_assets/img/top-logo.webp">
                                ...
                                <li class="nav-item text-center mb-3 mb-lg-0">
                                    <a class="nav-link fw-bolder lh-sm py-0 text-shadow_white" href="<?php echo home_url('lp'); ?>#section04">
                                        <picture>
    ...
    <main>
        ...
        <div class="bg-sub">
            ...
            <div class="d-flex justify-content-center align-items-center h-100">
                <h1 class="bg-white bg-opacity-50 px-5 py-3">お問い合わせ</h1>
            </div>
        </div>

        <!-- コンテンツ -->
        <div class="container py-5 mt-5">
            <div class="thanks-box text-center">
                <p class="thanks-title">お問い合わせありがとう<br class="d-block d-lg-none">ございました。</p>
                <p class="thanks-text">お問い合わせいただいた内容は<br class="d-block d-lg-none">正常に送信されました。</p>
            </div>
        </div>
    ...
    <script src="./sub/jquery.min.js.ダウンロード"></script>
    <script>
        // ページ内遷移位置調整
        $(function() {
